...
class ControlCompanyScreen extends StatefulWidget {
  ControlCompanyScreen({super.key});
  static String id = 'control_company_Screen';

  @override
  State<ControlCompanyScreen> createState() => _ControlCompanyScreenState();
}

class _ControlCompanyScreenState extends State<ControlCompanyScreen> {
  final pages = [
    HomeCompanyWidget(),
    ChatCompanyScreen(),
    profileScreen(),
